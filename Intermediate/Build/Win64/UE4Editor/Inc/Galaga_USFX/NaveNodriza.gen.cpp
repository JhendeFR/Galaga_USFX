...
// Cross Module References
	...
	GALAGA_USFX_API UClass* Z_Construct_UClass_UObserver_NoRegister();
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANaveNodriza_Statics::NewProp_Pawn_MetaData[] = {
		{ "Category", "Subscriptor" },
		{ "ModuleRelativePath", "NaveNodriza.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANaveNodriza_Statics::NewProp_Pawn = { "Pawn", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANaveNodriza, Pawn), Z_Construct_UClass_AGalaga_USFXPawn_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANaveNodriza_Statics::NewProp_Pawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANaveNodriza_Statics::NewProp_Pawn_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANaveNodriza_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANaveNodriza_Statics::NewProp_Pawn,
	};
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANaveNodriza_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UObserver_NoRegister, (int32)VTABLE_OFFSET(ANaveNodriza, IObserver), false },
		};
	...
	IMPLEMENT_CLASS(ANaveNodriza, 3880038518);
